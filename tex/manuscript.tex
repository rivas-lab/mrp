...
\thickhline
\textit{PGLYRP4} &              23.9 &   7.6 &     -0.1 &                                       -1.0 &                      -1.1 \\
\hline
\textit{ANGPTL7} &              12.9 &  12.2 &      1.7 &                                       10.5 &                       6.4 \\
\hline
\textit{JPH4}    &               6.4 &   2.7 &      0.6 &                                       -1.1 &                      -1.2 \\
\hline
\textit{WNT10A}  &               3.5 &   4.1 &     -0.2 &                                       -0.6 &                       3.1 \\
\hline
\textit{KLHL22}  &               3.1 &   3.7 &     -0.2 &                                        3.9 &                       2.2 \\
\hline
\textit{GLI3}    &               1.4 &   2.5 &     -0.4 &                                       -0.1 &                       4.3 \\
\hline
\textit{C4orf29} &              -0.0 &   6.4 &     -0.1 &                                       -0.7 &                      -1.1 \\
\hline
\end{tabular}
\end{adjustwidth}
\end{table}
