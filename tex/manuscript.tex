...
\paragraph*{Fig 2. Simulation studies.}
\label{simresults}
...
\paragraph*{Fig 3. Results for asthma application.}
\label{asthma_bma}
...
%\begin{figure}[!h]
%%\in\includegraphics[width=\textwidth]{../figures/final/Figure_04.pdf}
%\caption{{\bf Results for glaucoma application.}
\paragraph*{Fig 4. Results for glaucoma application.}
\label{glaucoma_bma}
