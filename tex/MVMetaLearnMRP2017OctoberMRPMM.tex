...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{glaucoma_manhattan.pdf}
  \caption{$\log_{10}$ Bayes Factors from applying MRP to summary statistics for missense and protein-truncating variants from (A) glaucoma (HC276), (B) intra-ocular pressure (INI5263), (C) corneal resistance factor (INI5265), and (D) all three traits jointly. (E) shows the results of a joint analysis focused on finding rare variants that protect against glaucoma. The genes outside of chromosome 6 with with Bayes Factor greater than three are indicated by arrows. Only $\log_{10}$ Bayes Factors greater than zero are plotted.}
  \label{glaucoma_manhattan}
\end{figure}

%% FIGURE 4
\begin{figure}
\centering
\includegraphics[width=\textwidth]{glaucoma_forest.pdf}
  \caption{$-\log_{10}$ $p$-values (left panel) and estimated effect sizes with 95\% confidence intervals (right panel) for missense variants and PTVs in \textit{ANGPTL7} for glaucoma, intra-ocular pressure, and corneal resistance factor.}
  \label{glaucoma}
\end{figure}
...
\bottomrule
\end{tabular}
\caption{$\log_{10}$ Bayes Factors for genes highlighted in Figure \ref{glaucoma_manhattan}.}
...
\includegraphics[width=\textwidth]{asthma_manhattan.pdf}
  ...
  \label{asthma_manhattan}
\end{figure}

%% FIGURE: ASTHMA FOREST PLOT
\begin{figure}
\centering
\includegraphics[width=\textwidth]{asthma_forest.pdf}
  \caption{$-\log_{10}$ $p$-values (left panel) and estimated effect sizes with 95\% confidence intervals (right panel) for missense variants and PTVs in \textit{IL33} for eosinophil counts, forced vital capacity (FVC), forced expiratory volume in 1-second (FEV1), and asthma.}
  \label{asthma_forest}
\end{figure}

%% TABLE: ASTHMA GENES OF INTEREST
\begin{table}
...
\bottomrule
\end{tabular}
\caption{$\log_{10}$ Bayes Factors for genes highlighted in Figure \ref{asthma_manhattan}.}
\label{asthma_table}
\end{table}
